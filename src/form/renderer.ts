  ...
  return `
    <div class="ats-success-container">
      ...
      <div class="ats-success-download-description">
        Download the .ZIP file containing your PDF certificate of anteriority and a JSON file that will allow you to protect multiple versions of the same work if needed.
      </div>
      ${
        explorerUrl
          ? `
      <div style="margin-top: 16px;">
        <a href="${escapeHtml(explorerUrl)}" target="_blank" rel="noopener noreferrer"
           style="display: inline-flex; align-items: center; gap: 8px; font-size: 14px; color: var(--ats-primary); font-weight: 500; text-decoration: none;"
