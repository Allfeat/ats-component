...
<CardGrid>
  ...
  <Card title="Access" icon="magnifier">
...
|---------|-----|-------|----------|
| **Pinned** | `cdn.allfeat.org/widgets/ats/1.2.0/ats-widget.iife.js` | Immutable | Reproducible builds |
| **Major** | `cdn.allfeat.org/widgets/ats/v1/ats-widget.iife.js` | 1h | Production (recommended) |
...
- **An Allfeat account with an organization** — create a standalone account on [app.allfeat.org](https://app.allfeat.org), then contact the Allfeat team to activate an organization linked to your account with the **ATS widget** enabled (subscription-based)
...
<CardGrid>
  <LinkCard title="Quick Start" href="/guides/quick-start/" description="Integrate the widget in 5 minutes with step-by-step instructions." />
  <LinkCard title="Authentication" href="/guides/authentication/" description="Set up JWT token management and secure your integration." />
  <LinkCard title="Events & Callbacks" href="/guides/events/" description="Track the full widget lifecycle with Custom Events." />
  <LinkCard title="Styling & Theming" href="/guides/styling/" description="Match the widget to your design system with CSS variables." />
</CardGrid>
