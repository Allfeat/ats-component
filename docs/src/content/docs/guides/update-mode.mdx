---
title: Update Mode
description: Register a new version of an existing work — update contributors, metadata, or the audio file using the ATS Widget's update mode.
---
...
2. ### File (optional)
   ...
   The user can choose to upload a new audio file or skip this step to reuse the existing one.
